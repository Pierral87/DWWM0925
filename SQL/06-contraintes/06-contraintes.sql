...
-- Pour "valider" la relation, en plus de catégoriser le champ prévu pour être une FK (foreign key) dans notre table, on va devoir rajouter une contrainte de clé étrangère 
...
(506, 'Volkswagen', 'Passat', 'gris', 'XN-973-MM');
  ...
  -- EXERCICES Contraintes - Foreign Key 
    ...
    -- 2 - Définir les modes de contraintes en fonction des souhaits de notre client ci-dessous :
        ...
        sur la relation vehicule ON DELETE SET NULL (attention à bien vérifier si le champ id_vehicule sur la table association est autorisé à être NULL)
